public class Pruebatienda3
{
	public static void main(String[] args)
	{
		Tienda t1 = new Tienda(10000,"USA");
		Producto p1 = new Producto(20,"Doritos");
		Producto p2 = new Producto(15,"Emperador");
		Producto p3 = new Producto(9,"Gansito");
		Producto p4 = new Producto(6,"Duvalin");
		Empleado e1 = new Empleado(100,"Diego","Chalan");
		Empleado e2 = new Empleado(1000,"Anallely","Gerente");
		Empleado e3 = new Empleado(500,"Cabello","Cajero");
		Empleado e4 = new Empleado(850,"Amairany","Tecnico");

		System.out.println("Info tienda 3:");
